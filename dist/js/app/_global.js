define(function (require) {
    ...
    var _bindInsightsSample = function() {
        var $container = $('.js-insights-sample-modal-content');
        var $toggle = $('.js-insights-sample-toggle');
        ...
        $toggle.on('click', function() {
            ...
            window.setTimeout(function() {
                $container.load(contentURL, function() {
                    $container.find('.js-insights-sample-modal-carousel').slick({
                        infinite: false,
                         speed: 100,
                    });
